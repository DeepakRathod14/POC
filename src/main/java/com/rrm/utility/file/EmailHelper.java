...
public class EmailHelper
{
	 ...
	 */
	public void mailConfiguration(String reportPath) throws Exception
	{
	 ...
	 *         the messaging exception
	 */
	public void sendMailViaGmail(String reportPath) throws Exception
	{
		...
		messageBodyPart1.setContent("<b>This is Auto Generated Mail.</b> You receive this mail because your email id is in recipient list. "
				+ "We notify you that ITS Automation Execution is finshed."
				+ "<br> Along with this email 'Framework' it self <b>attached one zip</b> file "
				+ "("+ContinuumSelenium.REPORT_ZIP_FILE_NAME+").<br><br> Which contains <b>Report.html</b> file as part of execution report.<br>"
				...
				+ "<br>"
				+ "Thank you,<br>"
				+ "ITS Automation Team,<br>"
				+ "Continuum.","text/html");

		//4) create new MimeBodyPart object and set DataHandler object to this object
		MimeBodyPart messageBodyPart2 = new MimeBodyPart();
		DataSource source = new FileDataSource(reportPath+"\\"+ContinuumSelenium.REPORT_ZIP_FILE_NAME);
		messageBodyPart2.setDataHandler(new DataHandler(source));
		messageBodyPart2.setFileName(ContinuumSelenium.REPORT_ZIP_FILE_NAME);
